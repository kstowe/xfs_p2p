...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\common.jar

@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" com.xfs.client.Client %CMD_LINE_ARGS%
